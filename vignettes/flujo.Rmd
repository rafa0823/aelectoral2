...
bd$fusionar_shp(shp = shp$shp$secc_22_cdmx,
                bd = "bd_partido")
#Se obtienen los nombres completos de las elecciones
bd$obtener_nombres_elecciones("bd_partido") #Esto se va al Tablero
```
