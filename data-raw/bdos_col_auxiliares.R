## code to prepare `bdos_col_auxiliares` dataset goes here
entidad <- "col"
...
pm_24 <- readr::read_csv(files_cand[[7]]) |>
  janitor::clean_names() |>
  ...
  reframe(partido_ci = if_else(!grepl("-|_", partido_ci), paste(partido_ci, collapse = "_"), partido_ci),
          .by = c(entidad, municipio, candidatura)) |>
