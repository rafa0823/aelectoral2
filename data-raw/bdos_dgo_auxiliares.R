...
alianzas_dgo_pm_19 %>% write_rds("inst/bdos_auxiliares_dgo//alianzas_dgo_pm_19.rda")
...
alianzas_dgo_pm_16 %>% write_rds("inst/bdos_auxiliares_dgo//alianzas_dgo_pm_16.rda")
...
alianzas_dgo_gb_16 %>% write_rds("inst/bdos_auxiliares_dgo//alianzas_dgo_gb_16.rda")
