## code to prepare `bdos_tab_locales` dataset goes here
library(readr)
library(dplyr)
...
# pm_18 -------------------------------------------------------------------
path <- "~/Google Drive/Unidades compartidas/3_Insumos/Externas/Limpieza/PEL/TAB/TAB_PEL_2018/AYUNTAMIENTOS_csv/2018_SEE_AYUN_TAB_CAS.csv"
...
path <- "~/Google Drive/Unidades compartidas/3_Insumos/Externas/Limpieza/PEL/TAB/TAB_PEL_2018/GUBERNATURA_csv/2018_SEE_GOB_TAB_CAS.csv"
...
path <- "~/Google Drive/Unidades compartidas/3_Insumos/Externas/Limpieza/PEL/TAB/TAB_PEL_2018/DIPUTACIONES_LOC_MR_csv/2018_SEE_DIP_LOC_MR_TAB_CAS.csv"
...
path <- "~/Google Drive/Unidades compartidas/3_Insumos/Externas/Limpieza/PEL/TAB/TAB_PEL_2021/DIPUTACIONES_LOC_MR_csv/2021_SEE_DIP_LOC_MR_TAB_CAS.csv"
