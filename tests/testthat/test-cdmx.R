test_that("tiene las columnas requeridas", {
  ...
  bd <- Electoral$new("dl_18", "cdmx", llaves = c("seccion", "municipio_18", "distritol_18"),
                      extranjero = FALSE)
  c("gb_18", "pm_18") |>
    walk(~bd$agregar_bd(eleccion = .x, entidad = "cdmx"))
  ...
  bd <- Electoral$new("dl_21", "cdmx", llaves = c("seccion", "municipio_21", "distritol_21"))
  c("pm_21") |>
    walk(~bd$agregar_bd(eleccion = .x, entidad = "cdmx"))
