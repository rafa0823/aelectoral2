...
alianzas_dgo_dl_18 %>% write_rds("inst/alianzas/alianzas_durango/alianzas_dgo_dl_18.rda")
...
alianzas_dgo_dl_16 %>% write_rds("inst/alianzas/alianzas_durango/alianzas_dgo_dl_16.rda")
