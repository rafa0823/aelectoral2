...
relacion_18 <- readxl::read_excel(path) |>
  ...
  distinct(distritof_18 = id_distrito, nombre_distritof_18 = cabecera_distrital,
           municipio_18 = id_municipio, nombre_municipio_18 = municipio, seccion)
# Relacion 21 -------------------------------------------------------------
