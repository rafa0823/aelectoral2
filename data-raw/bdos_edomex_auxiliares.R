...
alianzas_edomex_pm_21 %>% write_rds("inst/alianzas/alianzas_edomex/alianzas_edomex_pm_19.rda")
...
alianzas_edomex_pm_18 %>% write_rds("inst/alianzas/alianzas_edomex/alianzas_edomex_pm_18.rda")

#dl21

alianzas_edomex_gb_16 <- read.csv("~/Dropbox (Selva)/Ciencia de datos/Consultoría Estadística/Recursos/Externos/Limpieza/alianzas/locales/dl_21_edomex.csv") %>%
  janitor::clean_names() %>%
  as_tibble() %>%
  mutate(estado = "15",
         nombre_estado = "MÉXICO",
...
alianzas_edomex_dl_21 %>% write_rds("inst/alianzas/alianzas_edomex/alianzas_edomex_dl_21.rda")
...
alianzas_edomex_dl_18 %>% write_rds("inst/alianzas/alianzas_edomex/alianzas_edomex_dl_18.rda")
