test_that("tiene las columnas requeridas", {
  ...
  bd <- Electoral$new("dl_16", "q_roo", llaves = c("seccion", "municipio_16", "distritol_16"),
                      extranjero = FALSE)
  c("gb_16", "pm_16") |>
    walk(~bd$agregar_bd(eleccion = .x, entidad = "q_roo"))
  ...
  bd <- Electoral$new("pm_18", "q_roo", llaves = c("seccion", "municipio_18", "distritol_18"))
  ...
  bd <- Electoral$new("dl_19", "q_roo", llaves = c("seccion", "municipio_19", "distritol_19"))
